...
type AuctionClient interface {
	...
	GetResult(ctx context.Context, in *ResultRequest, opts ...grpc.CallOption) (*ResultReply, error)
}
...
func (c *auctionClient) GetResult(ctx context.Context, in *ResultRequest, opts ...grpc.CallOption) (*ResultReply, error) {
	out := new(ResultReply)
	err := c.cc.Invoke(ctx, "/Auction/GetResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuctionServer interface {
	...
	GetResult(context.Context, *ResultRequest) (*ResultReply, error)
...
func (UnimplementedAuctionServer) GetResult(context.Context, *ResultRequest) (*ResultReply, error) {
...
func _Auction_GetResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Auction/GetResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServer).GetResult(ctx, req.(*ResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}
